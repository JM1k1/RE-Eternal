...
module.exports = async (client, member) => {
  ...
  const helloEmbed = new MessageEmbed()
    ...
    .setDescription(
      ...
      Ты попал на игровой сервер ${member.guild.name}, где ты сможешь завести новые знакомства, открыть для себя новые игры и развлечения, а так же поднакопить игровых часов в нашем заведении, участвуя и организовывая игровые эвенты!
